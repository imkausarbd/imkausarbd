# Hi, I'm Kausar 👋 | AI Automation Engineer

I build AI agents, chatbots, and workflow automation systems that help businesses save time and cut manual work. Specializing in **n8n**, **Make.com**, **Claude AI**, **ChatGPT**, **RAG systems**, and **MCP integration**.

🔗 **Brand:** Build with Kausar
📍 Based in Sylhet, Bangladesh — working with clients worldwide

---

## 🛠️ Skills & Tools

`AI Agent Development` `n8n Workflow Automation` `Make.com Automation` `RAG Chatbots` `MCP Integration` `API & Webhook Automation` `Voice AI Agents` `CRM Automation` `Business Process Automation` `Claude AI` `ChatGPT` `Retell AI`
...
- 💼 Fiverr: [fiverr.com/kausar_ahmed_bd](https://www.fiverr.com/kausar_ahmed_bd)
- 🔗 LinkedIn: [linkedin.com/in/imkausarbd](https://www.linkedin.com/in/imkausarbd/)
- 📧 Email: kausarcontact@gmail.com

I'm available for freelance AI automation projects — let's automate the repetitive parts of your business so you can focus on growth.
